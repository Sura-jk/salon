...
const CATEGORIES = [
  { 
    ...
    image: 'https://images.unsplash.com/photo-1521590832167-7bcbfea44988?q=80&w=400&auto=format&fit=crop' 
  },
  { 
    id: 'nails', 
    label: 'Royal Nails', 
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background pb-32 overflow-y-auto overflow-x-hidden items-center">
      <div className="w-full max-w-lg md:max-w-2xl px-4 md:px-0">
        ...
        {/* Search & Filter Bar */}
        <section className="py-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
        ...
        {/* Hero Banner */}
        <section className="py-4 animate-in fade-in zoom-in-95 duration-1000 delay-200">
        ...
        <section className="py-8 animate-in fade-in slide-in-from-right-8 duration-700 delay-300">
        ...
        {/* Nearby Salons */}
        <section className="py-6 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-400">
